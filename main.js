...
(function () {
  ...
  var wrapper = document.getElementById('main_content'),
    ...
    externalPreview = function (source) {
      ...
      source =
        '<html><head><meta charset="utf-8"><link rel="shortcut icon" type="image/png" href="https://deobfuscator.bloggerbyte.net/favicon.png"><title>de4js | Preview</title><style>' +
        externalStyle +
    ...
    format = debounce(function () {
      ...
      if (!workerFormat) {
        workerFormat = new Worker('/worker/format.js');
    ...
    decode = debounce(function () {
      ...
      if (!workerDecode) {
        workerDecode = new Worker('/worker/decode.js');
